// querbeet R4/D4 — 30-Step pipeline and search runner (M5, M7). Polls window.__R__ so a 500k OOM
// still yields everything measured up to that point.
// Usage: node run-pipeline.mjs chromium | firefox
...
const url = pathToFileURL(resolve('pipeline-probe.html')).href;
