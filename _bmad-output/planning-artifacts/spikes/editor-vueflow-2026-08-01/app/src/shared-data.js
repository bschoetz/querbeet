...
// Object.freeze'd per row and on the array, exactly as R2's architecture rule
// requires. Carried over from the R6 probe unchanged, so the Editor skeleton is
// measured with a real dataset in it rather than an empty graph.
